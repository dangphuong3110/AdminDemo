...
<div class="container mt-5">
    <nav class="navbar navbar-expand-lg bg-body-tertiary border-bottom border-body fixed-top p-0">
        <div class="container-fluid pe-0">
            ...
            <a class="navbar-brand" href="#">Admin Demo</a>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="dropdown-center mt-3">
                ...
                <ul class="dropdown-menu dropdown-menu-dark">
                    <li><a class="dropdown-item" href="https://aitools.zozo.vn/ocr/convert-image-to-text" target="_blank">Scan text from Image</a></li>
                </ul>
            </div>
        </div>
    </div>
